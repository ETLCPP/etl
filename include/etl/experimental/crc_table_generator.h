...
private:
  ...
  static const bool   Do_Poly          = (Entry & (TAccumulator(1U) << (Accumulator_Bits - 1U))) != 0U;
...
//*****************************************************************************
template <typename TAccumulator, size_t Index, TAccumulator Polynomial, size_t CHUNK_BITS>
class table_entry;
...
class table_entry<TAccumulator, Index, Polynomial, Chunk_8_Bits>
{
//private:
public:

  static const size_t Accumulator_Bits = sizeof(TAccumulator) * CHAR_BIT;
  static const size_t Shift_Bits       = size_t(Accumulator_Bits - Chunk_8_Bits);
...
//*****************************************************************************
template <typename TAccumulator, size_t Index, TAccumulator Polynomial>
class table_entry<TAccumulator, Index, Polynomial, Chunk_4_Bits>
{
private:
...
//*****************************************************************************
template <typename TAccumulator, size_t Index, TAccumulator Polynomial>
class table_entry<TAccumulator, Index, Polynomial, Chunk_2_Bits>
{
private:
...
//*****************************************************************************
template <typename TAccumulator, TAccumulator Polynomial, size_t Table_Size>
struct crc_table;
